...
namespace DAL
{
    public class StatisticCustomerDAL : DataBase
    {
        private static StatisticCustomerDAL _instance;
        public static StatisticCustomerDAL Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new StatisticCustomerDAL();
                return _instance;
            }
            set { }
        }
